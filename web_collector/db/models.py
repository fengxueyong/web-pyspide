...
class ScrapTask(Base):
    ...
    res_type = Column(String(64), nullable=False, default="all", comment="资源类型：all-全部, image-图片, doc-文档, video-视频")
...
class Resource(Base):
    ...
    res_type = Column(String(32), nullable=False, comment="资源类型：image-图片, doc-文档, video-视频")
