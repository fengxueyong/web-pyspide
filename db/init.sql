...
CREATE TABLE IF NOT EXISTS t_scrap_task (
    ...
    res_type      VARCHAR(64)     NOT NULL DEFAULT 'all'      COMMENT '资源类型：all-全部, image-图片, doc-文档, video-视频',
...
CREATE TABLE IF NOT EXISTS t_resources (
    ...
    res_type      VARCHAR(32)   NOT NULL                    COMMENT '资源类型：image-图片, doc-文档, video-视频',
